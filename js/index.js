...
let procesar = (ps) => {
    ...
    console.log(primaria,secundaria)
    blanqueoData()
...
//mediocentros y centrocampistas
if(ps == 'todo' || ps == 'mf'){
...
let functionl1 = () => primaria = 0.55
let functionl2 = () => primaria = 0.60
let functionl3 = () => primaria = 0.70
let functionl4 = () => primaria = 0.75
let functionl5 = () => primaria = 0.80


process && process.addEventListener('click',() => procesar('todo'))
processGK && processGK.addEventListener('click',() => procesar('gk'))
processDF && processDF.addEventListener('click',() => procesar('df'))
processLT && processLT.addEventListener('click',() => procesar('lt'))
processMC && processMC.addEventListener('click',() => procesar('mf'))
processMP && processMP.addEventListener('click',() => procesar('mp'))
processFW && processFW.addEventListener('click',() => procesar('fw'))
l1 && l1.addEventListener('click', () => functionl1())
l2 && l2.addEventListener('click', () => functionl2())
l3 && l3.addEventListener('click', () => functionl3())
l4 && l4.addEventListener('click', () => functionl4())
l5 && l5.addEventListener('click', () => functionl5())